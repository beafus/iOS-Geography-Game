...
class MapsViewController: UIViewController {
    ...
    func nextQuestion(){
        ...
        var mapName = question["map"]
        questionImage.image = UIImage(named: mapName!)
        
        var answerRight = question["name"]
        
        rightAnswer = question["name"]!
        
        let country1 = countries[randomNumber2]
        let country2 = countries[randomNumber3]
        
        var answerWrong1 = country1["name"]
        var answerWrong2 = country2["name"]
